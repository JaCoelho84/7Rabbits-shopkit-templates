				...
				{{ form_open('account/save-profile', {'role': 'form'}) }}
					...
					<footer class="clearfix">
						...
						<div class=" margin-top-xxs pull-left">
							<small><a href="{{ site_url('account/delete') }}" class="text-error small" onclick="return confirm('Tem a certeza que deseja eliminar a sua conta?')"><i class="fa fa-trash" aria-hidden="true"></i> Eliminar Conta</a></small>
						</div>
