...
{% block content %}
	...
	<section class="content">
		...
		{{ form_open('cart/post/confirm', { 'class' : 'form' }) }}
			...
			<input type="text" value="{{ user.coupon }}" class="span6" id="cupao" name="cupao" placeholder="Se tiver um cupão de desconto, coloque-o aqui">

			<hr>

			<button type="submit" class="button">Prosseguir &nbsp; <i class="fa fa-chevron-circle-right "></i></button>
