				...
				{% if user.order_detail %}
					...
					<div class="row-fluid">
						<div class="span6 margin-bottom">
							...
							<strong>NIF:</strong> {{ user.order_detail.client.fiscal_id ? user.order_detail.client.fiscal_id : 'n/a' }}<br>
								...
								<tbody>
									{% for product in user.order_detail.products %}
										<tr>
											...
											<td class="text-right">
												<span class="text-light-gray">{{ product.quantity }}x {{ product.price|money_with_sign(user.order_detail.currency) }}</span><br>
